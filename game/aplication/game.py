...
from menu import *
from interface.register import Regitration
from database_connection.user import User
from recipes import *
...
class Game():
    def __init__(self):
        ...
        self.user = User()
        self.img = pygame.image.load('images/canva3.png')
        self.kitchen = pygame.image.load('images/kitchen.png')
        self.vamosCocinar = pygame.image.load('images/vamosCocinar.png')
        self.receta1 = pygame.image.load('images/Receta1.png')
        self.receta2 = pygame.image.load('images/Receta2.png')
        self.receta3 = pygame.image.load('images/Receta3.png')
        self.receta4 = pygame.image.load('images/Receta4.png')
        self.receta5 = pygame.image.load('images/Receta5.png')
        self.menuRecetas = pygame.image.load('images/menuRecetas.png')
    ...
    def set_user(self, player):
        self.user.id = player["_id"]
        self.user.name = player["nombre"]
        self.user.phone = player["telefono"]
        self.user.points = player["puntaje"]
    
    def set_new_user(self, _id, _name, _phone, _points):
        self.user.id = _id
        self.user.name = _name
        self.user.phone = _phone
        self.user.points = _points
